...
If the org profile has a GSTIN, load the `india-gst` skill for this step — it
covers which figure belongs to GSTR-1 vs GSTR-3B, the GSTR-2B ITC reconciliation
order, and why a `GST_FILED` invoice must be amended rather than edited.
